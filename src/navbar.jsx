...
function Navbar() {
    ...
    return (
        <motion.nav className="flex justify-center items-center fixed top-0 w-full z-50" initial={{ y: -100, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={transition}>
            <div className="font-lato flex justify-center items-center gap-2 cursor-pointer rounded-lg mt-2 p-1 tracking-wider bg-[#202020] border border-[#ffffff26] sm:gap-4 sm:px-2 sm:py-1">
