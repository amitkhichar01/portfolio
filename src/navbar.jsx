...
function Navbar() {
    ...
    return (
        <motion.nav className="flex justify-center items-center fixed top-0 w-full z-50" initial={{ y: -100, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={transition}>
            <div className="font-lato flex justify-center items-center gap-2 cursor-pointer rounded-full mt-2 p-1 tracking-wider bg-[#242526] shadow-[0px_0px_5px] shadow-gray-500 sm:gap-4 sm:px-2 sm:py-1">
